...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        'base-lightest': uswdsColors['gray-5'],
        'base-lighter': uswdsColors['gray-cool-10'],
        'base-light': uswdsColors['gray-cool-30'],
        base: uswdsColors['gray-cool-50'],
        'base-dark': uswdsColors['gray-cool-60'],
        'base-darker': uswdsColors['gray-cool-70'],
        'base-darkest': uswdsColors['gray-90'],
        ...
        'secondary-lighter': uswdsColors['red-cool-10'],
        'secondary-light': uswdsColors['red-30'],
        secondary: uswdsColors['red-50'],
        'secondary-vivid': uswdsColors['red-cool-50v'],
        'secondary-dark': uswdsColors['red-60v'],
        'secondary-darker': uswdsColors['red-70v'],
        'accent-cool-lighter': uswdsColors['blue-cool-5v'],
        'accent-cool-light': uswdsColors['blue-cool-20v'],
        'accent-cool': uswdsColors['cyan-30v'],
        'accent-cool-dark': uswdsColors['blue-cool-40v'],
        'accent-cool-darker': uswdsColors['blue-cool-60v'],
        'accent-warm-lighter': uswdsColors['orange-10'],
        'accent-warm-light': uswdsColors['orange-20v'],
        'accent-warm': uswdsColors['orange-30v'],
        'accent-warm-dark': uswdsColors['orange-50v'],
        'accent-warm-darker': uswdsColors['orange-60'],

        'info-lighter': uswdsColors['cyan-5'],
        'info-light': uswdsColors['cyan-20'],
        info: uswdsColors['cyan-30v'],
        'info-dark': uswdsColors['cyan-40v'],
        'info-darker': uswdsColors['blue-cool-60'],
        'error-lighter': uswdsColors['red-warm-10'],
        'error-light': uswdsColors['red-warm-30v'],
        error: uswdsColors['red-warm-50v'],
        'error-dark': uswdsColors['red-60v'],
        'error-darker': uswdsColors['red-70'],
        'warning-lighter': uswdsColors['yellow-5'],
        'warning-light': uswdsColors['yellow-10v'],
        warning: uswdsColors['gold-20v'],
        'warning-dark': uswdsColors['gold-30v'],
        'warning-darker': uswdsColors['gold-50v'],
        'success-lighter': uswdsColors['green-cool-5'],
        'success-light': uswdsColors['green-cool-20v'],
        success: uswdsColors['green-cool-40v'],
        'success-dark': uswdsColors['green-cool-50v'],
        'success-darker': uswdsColors['green-cool-60v'],
        'disabled-lighter': uswdsColors['gray-20'],
        'disabled-light': uswdsColors['gray-40'],
        disabled: uswdsColors['gray-50'],
        'disabled-dark': uswdsColors['gray-70'],
        'disabled-darker': uswdsColors['gray-90'],
        emergency: uswdsColors['red-warm-60v'],
        'emergency-dark': uswdsColors['red-warm-80'],
