    ...
    <Field className="relative">
      ...
      >
        <ComboboxInput
          ...
          className="peer border border-base-lighter h-12 px-2 focus:outline-hidden focus:ring-4 focus:ring-primary w-full rounded-xs shadow-md bg-white"
        ...
        {props.label && (
          <Label
            htmlFor={props.label}
            className="absolute top-1/2 -translate-y-1/2 left-2 text-base-dark transition-all peer-placeholder-shown:top-1 peer-placeholder-shown:text-ink peer-focus:top-1.5 peer-placeholder-shown:text-xs peer-focus:text-xs pointer-events-none"
          >
            {props.label}
          </Label>
        )}
