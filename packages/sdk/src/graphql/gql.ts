...
type Documents = {
    ...
    "\n  query GetElectionsPageMeta {\n    electionsPage {\n      title\n      description\n    }\n  }\n": typeof types.GetElectionsPageMetaDocument,
...
const documents: Documents = {
    ...
    "\n  query GetAssemblyPageMeta {\n    board(where: { title: \"Assembly\" }) {\n      title\n      description\n    }\n  }\n": types.GetAssemblyPageMetaDocument,
    "\n  query GetAssemblyDistricts($now: DateTime!) {\n    assemblyDistricts(orderBy:  {\n        title: asc\n    }) {\n      \n      title\n      slug\n      memberName\n      photo {\n        file {\n          url\n        }\n      }\n      bio\n    }\n\n    board(\n      where: { title: \"Assembly\" }\n    ) {\n      ...BasePageInfo\n      directory {\n        ...DocumentLink\n      }\n      \n    }\n  }\n": types.GetAssemblyDistrictsDocument,
    ...
    "\n  query GetCommunitiesPageMeta {\n    landingPage(where: { title: \"Communities\" }) {\n      title\n      description\n    }\n  }\n": types.GetCommunitiesPageMetaDocument,
    "\n  query CommunitiesPage($now: DateTime!) {\n    landingPage(where: {\n      title: \"Communities\"\n    }) {\n      heroImage\n      title\n      description\n      body\n      highlights(orderBy: {\n        priority: asc\n      }, take:3) {\n        id\n        createdAt\n        priority\n        ...HomePageHighlightCard\n      }\n    }\n\n    cities: communities(where: {\n      type:  {\n         equals: \"city\"\n      }\n    }) {\n      id\n      title\n      slug\n    }\n\n    towns: communities(where: {\n      type:  {\n         not:  {\n            equals: \"city\"\n         }\n      }\n    }) {\n      id\n      title\n      slug\n    }\n\n    events(take: 4, orderBy: {\n      startDate: desc\n    }, where: {\n      communities:  {\n         some:  {\n            status:  {\n               equals: \"published\"\n            }\n         }\n      }\n      startDate:  {\n         gte: $now\n      }\n    }) {\n      id\n      ...EventInfo\n    }\n  }\n": types.CommunitiesPageDocument,
    "\n  query GetOrgUnitMeta($slug: String!) {\n    orgUnit(where: { slug: $slug }) {\n      title\n      description\n    }\n  }\n": types.GetOrgUnitMetaDocument,
    "\n  query GetOrgUnit(\n    $slug: String!\n    $now: DateTime!\n  ) {\n    orgUnit(where: { slug: $slug }) {\n      ...BasePageInfo\n      showPage\n      children {\n        ...ChildrenOrgUnits\n      }\n      parent {\n        ...OrgUnitFields\n      }\n      parks {\n        ...PageList\n      }\n      facilities {\n        ...PageList\n      }\n      trails {\n        ...PageList\n      }\n      boards {\n        ...PageList\n      }\n    }\n  }\n  ": types.GetOrgUnitDocument,
    "\n  query GetDepartmentsPageMeta {\n    landingPage(where: { title: \"Departments\" }) {\n      title\n      description\n    }\n  }\n": types.GetDepartmentsPageMetaDocument,
    "\n  query GetDepartmentsPage {\n    landingPage(where: {title: \"Departments\"}) {\n      heroImage\n      title\n      description\n      body\n    }\n\n    orgUnits(where: {\n      AND: [\n        {\n          OR: [\n            { type: { equals: \"department\" } },\n            { type: { equals: \"office\" } }\n          ]\n        },\n        {\n          showPage: { equals: \"yes\" }\n        }\n      ]\n    }, orderBy:  {\n       title: asc\n    }) {\n      id\n      title\n      description\n      slug\n      type\n      icon\n    }\n  }\n": types.GetDepartmentsPageDocument,
    "\n  fragment GetAbsenteeVotingInfo on Query {\n    electionsPage {\n      stateElectionContact {\n        phone\n        name\n        ...ContactFields\n      }\n      boroughElectionContact {\n        phone\n        name\n        ...ContactFields\n      }\n    }\n\n    elections(take: 1, orderBy: { electionDate: desc}) {\n      earlyVotingStartDate\n      electionDate\n      absenteeVotingApplication {\n        ...DocumentLink\n      }\n      absenteeApplicationDeadline\n    }\n  }\n": types.GetAbsenteeVotingInfoFragmentDoc,
    "\n  fragment Election_BallotPropositions on Query {\n    elections(take: 1, orderBy: {\n      electionDate: desc\n    }) {\n      propositions(orderBy: {order: asc}) {\n        id\n        title\n        document {\n          ...DocumentLink\n        }\n        description\n      }\n    }\n    electionsPage {\n      referendumProcessDocument {\n        ...DocumentLink\n      }\n      boroughElectionContact {\n        name\n        phone\n      }\n    }\n  }\n": types.Election_BallotPropositionsFragmentDoc,
    "\n  fragment CandidateFilingInfo on Election {\n    title\n    candidates {\n      id\n      ...DocumentLink\n    }\n    electionDate\n    officesToBeFilled\n    candidateFilingStartDate\n    candidateFilingDeadline\n    candidateFilingDocuments {\n      id\n      ...DocumentLink\n    }\n  }\n": types.CandidateFilingInfoFragmentDoc,
    "\n  fragment GetEarlyVotingLocations on Query {\n    electionsPage {\n      earlyVotingLocations(orderBy:  {\n         order: asc\n      }) {\n        order\n        title\n        address {\n          lineOne\n          lineTwo\n          city\n          state\n          zip\n        }\n        hours {\n          id\n          day\n          open\n          close\n        }\n      }\n    }\n\n    elections(take: 1, orderBy: { electionDate: desc}) {\n      earlyVotingStartDate\n      electionDate\n      absenteeVotingApplication {\n        ...DocumentLink\n      }\n      absenteeApplicationDeadline\n    }\n  }\n": types.GetEarlyVotingLocationsFragmentDoc,
    ...
    "\n  fragment PageViewsList on TopPage {\n    pageId\n    item {\n      __typename\n      ... on BasePageWithSlug {\n        id\n        slug\n      }\n\n      ... on ElectionsPage {\n        id\n        title\n      }\n\n      ... on Url {\n        title\n        url\n      }\n\n      ... on AssemblyDistrict {\n        title\n        slug\n      }\n\n      ... on Topic {\n        title\n        slug\n      }\n\n      ... on BasePage {\n        title\n      }\n    }\n  }\n": types.PageViewsListFragmentDoc,
    "\n  query GetTopPagesMeta {\n    landingPage(where: { title: \"Top Pages\" }) {\n      title\n      description\n    }\n  }\n": types.GetTopPagesMetaDocument,
    "\n  query GetTopPages($topPagesDate: DateTime!, $trendingPagesDate: DateTime!) {\n    landingPage(where: { title: \"Top Pages\" }) {\n      title\n      heroImage\n      body\n      description\n    }\n\n    highlights(orderBy:  {\n       priority: asc\n    }, take: 8) {\n      id\n      createdAt\n      priority\n      ...HomePageHighlightCard\n    }\n\n    topPages: topPages(\n      after: $topPagesDate\n      take: 10 \n    ) {\n      ...PageViewsList\n    }\n\n    trendingPages: topPages(\n      after: $trendingPagesDate\n      take: 100 \n    ) {\n      ...PageViewsList\n    }\n  }\n": types.GetTopPagesDocument,
