...
export function CandidateFilingInfo(props: {
  ...
  return (
    <PageSection title="Candidate Filing Information" headerSize="lg">
      <ProseWrapper>
        {data?.candidateBody ? (
          <MarkdownRenderer>{data?.candidateBody}</MarkdownRenderer>
        ) : (
          <>
            <p>
            ...
            <blockquote className="bg-green-100 border-l-green-500 rounded not-italic">
              ...
              <ul>
                ...
                <li>
                  Candidates shall provide proof that they are eligible or shall
                  be eligible by the date of the election, to be recognized as a
