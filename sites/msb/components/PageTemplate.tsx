  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-12 gap-4">
        <div className="bg-base-lightest rounded p-4 col-span-8 flex flex-col gap-4 ">
          <div className="prose">
            <h1>Page title</h1>
            <p>
          ...
          <div className="bg-base-lighter rounded p-4">
            <h2 className="text-2xl font-bold mb-4">Services</h2>
            <div className="grid grid-cols-12 gap-4">
              <div className="rounded bg-base-light rounded p-4 col-span-6"></div>
              <div className="rounded bg-base-light rounded p-4 col-span-6"></div>
              <div className="rounded bg-base-light rounded p-4 col-span-6"></div>
              <div className="rounded bg-base-light rounded p-4 col-span-6"></div>
            </div>
        ...
        <div className="bg-base-lightest rounded p-4 col-span-4 flex flex-col gap-4">
          <div className="bg-base-lighter rounded p-4" w-full>
